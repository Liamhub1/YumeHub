...
local PresetColor = Color3.fromRGB(128, 0, 128)
...
PresetColor = preset or Color3.fromRGB(128, 0, 128)
fs = false
...
LoadText.TextColor3 = Color3.fromRGB(128, 0, 128)
LoadText.TextSize = 18.000
LoadText.TextTransparency = 1
LoadText.Text = "\224\184\129\224\184\179\224\184\165\224\184\177\224\184\135\224\185\130\224\184\171\224\184\165\224\184\148\46\46\46"
...
LoadTitle.TextColor3 = Color3.fromRGB(128, 0, 128)
...
LoadText.Text = "\224\184\129\224\184\179\224\184\165\224\184\177\224\184\135\224\185\128\224\184\138\224\185\135\224\184\132\224\185\128\224\184\129\224\184\161\46\46\46"

wait(1)

Barload:TweenSize(UDim2.new(0, 100,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
LoadText.Text = "\224\185\128\224\184\129\224\184\161"..tostring(game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name).."..."

wait(.5)

Barload:TweenSize(UDim2.new(0, 150,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
LoadText.Text = "\224\184\129\224\184\179\224\184\165\224\184\177\224\184\135\224\184\163\224\184\177\224\184\154\224\184\130\224\185\137\224\184\173\224\184\161\224\184\185\224\184\165\46\46\46"

wait(.5)

Barload:TweenSize(UDim2.new(0, 200,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
LoadText.Text = "\224\185\128\224\184\149\224\184\163\224\184\181\224\184\162\224\184\161\224\184\158\224\184\163\224\185\137\224\184\173\224\184\161\46\46"

wait(.5)

Barload:TweenSize(UDim2.new(0, 292,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
LoadText.Text = "\224\184\158\224\184\163\224\185\137\224\184\173\224\184\161\33"
...
NotificationHold.TextColor3 = Color3.fromRGB(128, 0, 128)
...
OkayBtn.Text = ""
OkayBtn.TextColor3 = Color3.fromRGB(128, 0, 128)
...
OkayBtnTitle.TextColor3 = Color3.fromRGB(128, 0, 128)
...
NotificationTitle.TextColor3 = Color3.fromRGB(128, 0, 128)
...
NotificationDesc.TextColor3 = Color3.fromRGB(128, 0, 128)
...
TabBtn.Text = ""
TabBtn.TextColor3 = Color3.fromRGB(128, 0, 128)
...
ButtonTitle.TextColor3 = Color3.fromRGB(128, 0, 128)
...
Toggle.Text = ""
Toggle.TextColor3 = Color3.fromRGB(128, 0, 128)
...
ToggleTitle.TextColor3 = Color3.fromRGB(128, 0, 128)
ToggleTitle.TextSize = 14.000
ToggleTitle.TextXAlignment = Enum.TextXAlignment.Left

FrameToggle1.Name = "FrameToggle1"
FrameToggle1.Parent = Toggle
FrameToggle1.BackgroundColor3 = Color3.fromRGB(128, 0, 128)
...
FrameToggleCircle.BackgroundColor3 = Color3.fromRGB(128, 0, 128)
